<h3>wp.media.view.PriorityList</h3>
<p>Manages subviews, ordering by numerical order. Utilizes wp.Backbone.Subviews.</p>
<div class="example">
	<h3>Example: Render multiple views in a priority list.</h3>
