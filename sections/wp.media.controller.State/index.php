...
<p>Extends directly from Backbone.Model. The current mode of each region is stored internally via model attributes.</p>
<p>Media frames (which are mixins including <a href="<?php echo WPMT::get_section_url( 'wp.media.controller.StateMachine' ) ?>"><code>wp.media.controller.StateMachine</code></a>) include multiple states.</p>
<p>A state
